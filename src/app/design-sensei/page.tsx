...
// ── Redirect: Design Sensei → Product Studio ──
// Design Sensei has been merged into the unified Product Studio pipeline.

export default function DesignSenseiRedirect() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center min-h-screen bg-[var(--bg-primary)]">
      <div className="text-center space-y-3">
        ...
        <p className="text-xs text-white/30">Design Sensei has been merged into the unified Product Studio.</p>
      </div>
    </div>
  );
}
